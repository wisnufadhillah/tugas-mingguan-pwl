...
<div class="container mt-5">
    <p class="text-left">Anda Login Sebagai "<?php echo $_SESSION['username']; ?>" | Klik <a
            href="../pages/logout.php">disini</a> untuk logout.</p>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <a href="berita_ubah.php?berita_id=<?php echo $data['berita_id']; ?>"
                        class="btn btn-warning btn-sm">Edit</a>
                    <a href="berita_hapus.php?berita_id=<?php echo $data['berita_id']; ?>"
