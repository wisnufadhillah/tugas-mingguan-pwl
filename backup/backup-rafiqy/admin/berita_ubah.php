        ...
        <table>
            <tr>
                ...
                <td>
                    ...
                    <input type="text" name="judul" size="50" value="<?php echo $data['berita_judul'] ?>">
                </td>
            </tr>
            <tr>
                <td>Isi Berita</td>
                <td>:</td>
                <td>
                    <textarea name="isi" rows="6" cols="45"><?php echo $data['berita_isi'] ?></textarea>
                </td>
            </tr>
            <tr>
                <td>Tanggal</td>
            ...
            <tr>
                ...
                <td>:</td>
                <td>
                    <input type="text" name="user_nama" size="50" value="<?php echo $_SESSION['username']; ?>" readonly>
                </td>
            </tr>
            <tr>
                <td colspan="3">
